...
def load_dataset(input_dir="/content/drive/MyDrive/CS598_DL4H_Project/CADRE-master/data/input", repository="gdsc", drug_id=-1, shuffle_feature=False):
  ...
  rng = []
  with open('/content/drive/MyDrive/CS598_DL4H_Project/CADRE-master/data/input/rng.txt', 'r') as f:
    for line in f:
      v = int(line.strip())
      if v < num_sample:
        rng.append(v)
...
def load_dataset_autoencoder(input_dir="/content/drive/MyDrive/CS598_DL4H_Project/CADRE-master/data/input", repository="gdsc", omic="exp"):
  """ Load dataset. Samples will be shuffled and all omics data and sensitivity
  data will be in the same order of samples.
