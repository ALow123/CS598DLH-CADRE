  ...
  def __init__(
    ...
    if init_gene_emb:
      if self.repository == 'gdsc':
        #GDSC dataset
        gene_emb_pretrain = np.genfromtxt('/content/drive/MyDrive/CS598_DL4H_Project/CADRE-master/data/input/exp_emb_gdsc.csv', delimiter=',')
      else:
        gene_emb_pretrain = np.genfromtxt('/content/drive/MyDrive/CS598_DL4H_Project/CADRE-master/data/input/exp_emb_ccle.csv', delimiter=',')
