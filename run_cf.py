...
parser.add_argument("--input_dir", help="directory of input files", type=str, default=PATH_PREFIX+"data/input")
parser.add_argument("--output_dir", help="directory of output files", type=str, default=PATH_PREFIX+"data/output")
...
'''
  for trial in range(0, 100):
    if os.path.exists(PATH_PREFIX+"data/output/cf-rep/logs"+str(trial)+".pkl"):
      continue
    print(trial)
    with open(PATH_PREFIX+"data/output/cf/logs"+str(trial)+".pkl", "wb") as f:
